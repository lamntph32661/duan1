...
<table style="border: 1; border-collapse: collapse;">
    ...
    <tbody>
        ...
        foreach ($load_ctdh as $donhang) {
            extract($ttdh);
            $mualai="";
            extract($donhang);$linksp = "index.php?act=product-detail&id_san_pham=" . $id_san_pham;
...
if($trang_thai=="Đang giao"||$trang_thai=="Đã nhận") echo $capnhat2; else echo $capnhat4;
